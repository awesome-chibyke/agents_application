	 ...
	 <div class="row">
			...
			<div class="col-12">
                    <div style="width: 100%; text-align: left;" class="pull-left  wow fadeInUp">
                        <span class="pull-left"><h5><?php print $reduce_text_lent($user_data['company_name'],50);?></h5></span>
                        
                      <!--<span class="pull-right">
                        <span class="pull-right"> 
                        	<select style="margin-bottom:5px !important;" class="form-control" name="goToCat" id="goToCat">
                       ...
                       <input id="baseurl" value="<?php //print base_url();?>" type="hidden" name="baseurl" />
						...
						<span style="padding-top: 10px; padding-right: 10px;" class="pull-right">Sort By:</span>
                       </span>-->
                         ...
                         <?php $cat_set = $cat_set;?>
                        	<select style="margin-bottom:5px !important;" class="form-control" name="goToCat" id="goToCat">
								...
								<option <?php if(str_replace(" ","-",$category[$i]['property_category'])==$cat_set) print 'selected="selected"';?> value="<?php echo str_replace(" ","-",$category[$i]['property_category']);?>"><?php echo $category[$i]['property_category'];?></option>
								<?php }?>
						   </select>
                       <input id="baseurl" value="<?php print base_url();?>" type="hidden" name="baseurl" />
                        </span>
	...
	<?php				
      ...
      <div style="margin-top: ;" class="col-12 col-lg-4 wow fadeInUp" data-wow-delay="750ms">
		  ...
		  <div class="col-12 boder_padd shadow">
         	 <a href="<?php print base_url();?>users/add-property">
				<button class="btn btn-primary col-12 fa fa-plus"> Add Properties</button>
          	</a>
          </div>
          ...
          <div class="col-12 boder_padd2">
          	 ...
          	 <li>Published Properties: 0</li>
			 <li>Unpublished Properties: 0</li>
			 <li>Total Properties: 0</li>
            <hr>
             <li>Basic Properties: 0</li>
             <li>Featured Properties: 0</li>
             <li>Featured Plus Properties: 0</li>
           </div> 
           <div class="col-12 boder_padd2">
             <h4>About Subscription</h4>
             <li>Plan: <span class="text-success">Free</span></li>
          </div>
          
          <div class="col-12 boder_padd shadow">
         	 <a href="<?php print base_url();?>users/add-property">
				<button class="btn btn-primary col-12 "> Make Request</button>
          	</a>
          </div>
          ...
          <div class="col-12 boder_padd2 item_cards">
			...
			<span class="text-success">Pay Online<br/></span><br />
