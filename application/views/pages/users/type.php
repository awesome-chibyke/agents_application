   ...
   <section class="featured-properties-area">
	<div class="container">
	 <div class="row">
            ...
            <div class="is_card">A total of <?php print number_format($total_row);?> <?php print @$typee;?> Properties <?php print $cat;?> in <?php print $siteInfo['siteName'];?>. Among these properties are houses, office, lands, shops, flats etc.We verify every property posted here you have nothing to be afraid of.</div>    						
